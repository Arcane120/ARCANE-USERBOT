...
async def promote(promt):
    ...
    try:
        ...
        await promt.edit(f"𝐘𝐮𝐩𝐩 𝐓𝐡𝐢𝐬 𝐔𝐬𝐞𝐫 𝐈𝐬 𝐏𝐫𝐨𝐦𝐨𝐭𝐞𝐝 𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 𝐁𝐲 {BOT} ⚡\n 𝐀𝐫𝐜𝐚𝐧𝐞 𝐔𝐬𝐞𝐫𝐛𝐨𝐭 𝐔𝐬𝐞𝐝 𝐛𝐲 {MASTER} 🔥")
...
async def ban(bon):
    ...
    await bon.edit("`𝐒𝐡𝐮𝐭 𝐓𝐡𝐞 𝐅𝐮𝐜𝐤 𝐎𝐟𝐟 𝐀𝐧𝐝 𝐓𝐚𝐤𝐞 𝐓𝐡𝐢𝐬 𝐁𝐚𝐧`")
