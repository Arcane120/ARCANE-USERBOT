...
BOT = str(botnickname) if botnickname else "𝙰𝚁𝙲𝙰𝙽𝙴 𝚄𝙱"
NAME = str(ALIVE_NAME) if ALIVE_NAME else "𝙰𝚁𝙲𝙰𝙽𝙴 𝚄𝚂𝙴𝚁"
PHOTO = os.environ.get("ALIVE_PHOTTO", None)
ARCANE = "[ARCANE](https://t.me/Arcane_Bot_Updates)"
VERSION = "0.0.1"
...
ID = ID
id = id
REPO = "[ARCANE USERBOT](https://github.com/Arcane120/ARCANE-USERBOT)"
